...
public class Death : MonoBehaviour
{
    ...
    {
        m_BreakableObject = ObjectPool.SharedInstance.GetPooledObject();
        if ( m_BreakableObject != null )
        {
            m_BreakableObject.transform.position = transform.position;
